...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("sessions", "List recent Hermes sessions from the gateway", "Session",
               gateway_only=True, args_hint="[limit]"),
    CommandDef("tmux", "List, capture, stop, or normalize tmux panes from the gateway", "Session",
               gateway_only=True, args_hint="[list|capture <target> [lines]|stop <target>|normalize [prefix]]",
               subcommands=("list", "capture", "stop", "normalize", "rename")),
    CommandDef("send", "Send a message to a tmux pane", "Session",
               gateway_only=True, args_hint="<target> <message>"),
    CommandDef("dashboard", "Show a compact gateway operator dashboard", "Session",
               gateway_only=True, aliases=("dash",)),
